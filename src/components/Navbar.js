  ...
  return (
    <div>
      ...
      >
          ...
          <div>
            <div className="flex items-center py-3 md:py-5 ">
              ...
              <div className="md:hidden z-30">
                <button
                  class={`hamburger hamburger--vortex ${navbar && "is-active"
                    } `}
                  type="button"
                  onClick={() => {
                    setNavbar((val) => !val);
              ...
              >
                <img src={image} class="h-8" alt="navbar face" />
                <span
          ...
          <div>
            ...
            >
              <ul className=" md:h-auto ml-32 items-center justify-center md:flex ">
                {pages.map((page, i) => {
                  return (<li
                    className={`pb-6 pt-6 text-xl text-black py-2 md:px-3 text-center  ${i == activeIndex && "navlink"} ${navbar && "hidden"
                      }`}
                      onClick={() => {
                        setActiveIndex(i);
                      }}
        ...
        ></div>}
        <div
          className={` absolute top-0 left-0 z-10 pt-20 ${navbar && "toggleInn"} ${navbar ? " " : "hidden"
            }`}
